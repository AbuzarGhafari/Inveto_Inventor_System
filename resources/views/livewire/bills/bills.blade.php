        ...
        <div class="col-sm-12">
            <div class="white-box">
                ...
                <div class="bills-tabs-btns d-flex">
                    ...
                    <button wire:click="pendingBills" class="pending {{ $activeTab == 'pending' ? 'active' : '' }}">Pending</button>
                    <button wire:click="delayedBills" class="delayed {{ $activeTab == 'delayed' ? 'active' : '' }}">Delayed</button>
                    <button wire:click="completedBills" class="completed {{ $activeTab == 'completed' ? 'active' : '' }}">Completed</button>
                </div>
